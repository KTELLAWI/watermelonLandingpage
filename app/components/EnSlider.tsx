...
import { enfeedback, entestimonilasheadertitle } from '../constants';
...
const EnSlider = () => {
    ...
    useEffect(() => {
        if (sliderRef.current && enfeedback.length > 0) {
    ...
    return (
        <section dir="ltr" className=" rounded-2xl  testimonial-section ptb-100">
                        ...
                        <div className="hidden lg:mt-8 lg:flex lg:gap-4">
                            ...
                            >
                                <svg
                                    ...
                                    strokeWidth="1.5"
                                    stroke="currentColor"
                                    className="h-5 w-5 ltr:rotate-180"
                                >
