...
import { enjoinusForm, joinUscontactForm } from "../../../constants";
      ...
      <div className="container my-24 mx-auto md:px-6">
        <section className="mb-32">
          <div className="flex flex-wrap">
            <div className="mb-12 w-full shrink-0  grow-0 basis-auto lg:mb-0 lg:w-5/12">
              <div className="flex relative h-[200px]  lg:py-12 ">
                ...
                <div className="w-full absolute flex-col top-[40%]  my-auto lg:ml-[50px]  z-[11]  flex items-center justify-center  ">
                  <h1 className=" text-right mb-8 text-3xl font-bold text-white">Join us</h1>
                  <Image
                    src={app1}
                    alt=""
                    width={0}
            ...
            <div className="w-full shrink-0 grow-0 basis-auto lg:w-7/12 text-right">
              ...
              <div
                ...
                <EmbededComponent url={enjoinusForm} />
